...
namespace Loans.Tests
{
    ...
    public class ProductComparerShould
    {
        ...
        [Test]
        public void ReturnNonNullEmptyComparision() {
            List<MonthlyRepaymentComparison> comparison = sut.CompareMonthlyRepayments(new LoanTerm(30));
            //comparison = null;
            comparison.Should().NotBeNullOrEmpty();
        }

        [Test]
        public void ReturnComparionsSortedByProductName() {
        ...
        public void AssertionScopes() {
            ...
            using (new AssertionScope()) {
                ...
                comparisons.Should().HaveCount(3); //fail - should be 3
                comparisons.Should().OnlyHaveUniqueItems();
